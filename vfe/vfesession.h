...
namespace vfe
{
  ...
  {
    vfeNoError = 0,
    vfeNoInputFile = 1024,                        // 0  "No input file provided"
    vfeRenderBlockSizeTooSmall,                   //    "Specified block size is too small"
    vfeFailedToWriteINI,                          // 2  "Failed to write output INI file"
    vfeFailedToSetSource,                         // 3  "Failed to set source file"
    vfeFailedToParseINI,                          // 4  "Failed to parse INI file"
    vfeIORestrictionDeny,                         // 5  "I/O Restrictions prohibit access to file"
    vfeFailedToParseCommand,                      // 6  "Failed to parse command-line option"
    vfeFailedToSetMaxThreads,                     // 7  "Failed to set number of render threads"
    vfeFailedToSendRenderStart,                   // 8  "Failed to send render start request"
    vfeRenderOptionsNotSet,                       // 9  "Render options not set, cannot start render"
    vfeAlreadyStopping,                           // 10 "Renderer is already stopping"
    vfeNotRunning,                                // 11 "Renderer is not running"
    vfeInvalidParameter,                          // 12 "Something broke but we're not sure what"
    vfeSessionExists,                             // 13 "Only one session at once permitted in this version"
    vfePOVMSInitFailed,                           // 14 "Failed to initialize local messaging subsystem"
    vfeOpenContextFailed,                         // 15 "Failed to open context with core messaging subsystem"
    vfeConnectFailed,                             // 16 "Failed to connect to core messaging subsystem"
    vfeInitializeTimedOut,                        // 17 "Timed out waiting for worker thread startup"
    vfeRequestTimedOut,                           // 18 "Timed out waiting for request to be serviced"
    vfeFailedToInitObject,                        // 19 "Failed to initialize internal options storage"
    vfeCaughtException,                           // 20 "Caught exception of unexpected type"
    vfeCaughtCriticalError,                       // 21 "Caught critical error"
    vfeDisplayGammaTooSmall,                      // 22 "Specified display gamma is too small"
    vfeFileGammaTooSmall,                         // 23 "Specified file gamma is too small"
    vfeUnsupportedOptionCombination,              // 24 "Unsupported option combination"
  } ;
