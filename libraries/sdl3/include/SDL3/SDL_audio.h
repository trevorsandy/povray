 ...
 * on-demand, which maps pretty closely to the SDL3 audio model.
 *
 ...
 * partially to offer a clean migration for SDL3 apps and partially because
 ...
 * audio playing, bind a stream and supply audio data to it. Unlike SDL3,
 * there is no audio callback; you only bind audio streams and make sure they
 * have data flowing into them (however, you can simulate SDL3's semantics
 ...
 * from SDL3, you should open a default device ID and use an SDL hint to
 ...
 *
 * Unlike in SDL3, audio devices start in an _unpaused_ state, since an app
 ...
 * different than SDL3, where data was converted during the Put call and the
 ...
 * is different than SDL3, where that work was done while inputting new data
 ...
 *
 * This is also intended to be a clean means to migrate apps from SDL3.
 *
 ...
 * more closely to SDL3-style behavior, since there is no extra step here to
